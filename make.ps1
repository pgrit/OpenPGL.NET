...
cp $prebuilt/linux/lib/libopenpgl.so.0.5.0 runtimes/linux-x64/native/
...
cp $prebuilt/osx/lib/libopenpgl.0.5.0.dylib runtimes/linux-x64/native/
...
cp $prebuilt/osx-arm64/lib/libopenpgl.0.5.0.dylib runtimes/linux-x64/native/
